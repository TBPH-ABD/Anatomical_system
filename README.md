...
| الأداة | ماذا تفعل |
| --- | --- |
| **وضع الاختبار** | يخفي الاسم ويطلب منك تحديد البنية على النموذج، ويحسب النتيجة والإجابات المتتالية الصحيحة. مصدر الأسئلة: الأجهزة الظاهرة، أو المفضلة، أو النموذج كامل. |
...
يتطلب Node.js 22.13 أو أحدث. لا يحتاج أي مفتاح أو حساب لتشغيل النموذج نفسه.
